...
invalidHP = Logger.LogMessage Logger.Error      
    "Invalid host path"

noUpd :: Logger.LogMessage 
noUpd = Logger.LogMessage Logger.Error      
    "No update was found"

badServerResponse :: Logger.LogMessage 
badServerResponse = Logger.LogMessage Logger.Error      
