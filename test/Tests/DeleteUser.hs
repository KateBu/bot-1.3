...
testDeleteUser1 = TestCase (assertEqual "Config.deleteUser1"
    expectedDeleteUser1
    actualDeleteUser1)
...
testDeleteUser2 = TestCase (assertEqual "Config.deleteUser2"
    expectedDeleteUser2
    actualDeleteUser2)
...
testDeleteUser3 = TestCase (assertEqual "Config.deleteUser3"
    expectedDeleteUser3
    actualDeleteUser3)
