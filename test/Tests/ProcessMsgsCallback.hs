...
testProcessMsgsCallback =
  [ testProcessMsgsCallback1,
    testProcessMsgsCallback2,
    testProcessMsgsCallback3,
    testProcessMsgsCallback4
  ]
...
expectedProcessMsgsCallback1 = pure . pure $ Config.configSetOffset newConfig 1
  where
...
testProcessMsgsCallback2 =
  TestCase
    ( assertEqual
        "Logic.testProcessMsgsCallback2"
...
expectedProcessMsgsCallback2 = pure . pure $ Config.configSetOffset newConfig 1
  where
...
testProcessMsgsCallback3 =
  TestCase
    ( assertEqual
        "Logic.testProcessMsgsCallback3"
...
expectedProcessMsgsCallback3 = pure . pure $ Config.configSetOffset newConfig 1
  where
